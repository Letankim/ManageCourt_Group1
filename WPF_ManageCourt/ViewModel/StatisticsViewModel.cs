...
namespace WPF_ManageCourt.ViewModel
{
    public class StatisticsViewModel : BaseViewModel
    {
        ...
        private async Task LoadDataAsync()
        {
            ...
            TimeLabels.Clear();
            BookedSlotValues.Clear(); // Thêm dòng này để xóa dữ liệu cũ của BookedSlotValues
            AccessoryLabels.Clear();
            AccessoryValues.Clear();
            ...
            // Load revenue data
            var revenueData = await _bookingService.StatisticsAsync(startDay, endDay);
            ...
            var statusData = await _bookingService.StatisticStatus(startDay, endDay);
            ...
            //Payment
            var paymentData = await _bookingService.StatisticPayment(startDay, endDay);
